...
(1, 'vtrung', 'vtrung@gmail.com', '$2b$10$YgasEyfrUmTJw7qQ6LZ0a.2fEIVLy74R0PVph1084OqA0rzq2S2jW');
INSERT INTO `users` (`user_id`, `full_name`, `email`, `password`) VALUES
(3, 'vtrung1', 'vtrung1@gmail.com', '$2b$10$3tcOSbLEqnimAWrOQ6UtaeNmlHOErtftuqfaRjAcE29e5n9rDFJYC');
INSERT INTO `users` (`user_id`, `full_name`, `email`, `password`) VALUES
(4, 'vtrung2', 'vtrung2@gmail.com', '$2b$10$6945LO0FLt9hVK9Ph1UGH.rSSkdsFX6eF04l8ieAeG1VtJeRY/k5i');
INSERT INTO `users` (`user_id`, `full_name`, `email`, `password`) VALUES
(5, 'vtrung3', 'vtrung3@gmail.com', '$2b$10$S/dmwhR5CWjta76.HiGp/OOP4we1X0OJ53omXTyDavsPKkx3P26RG'),
(6, 'vtrung4', 'vtrung4@gmail.com', '$2b$10$nkDo.tw8aNUKu9z/gZE0kOC6OQzYD12ReiAOLn5y0obuVWBKSvAgC'),
(7, 'vtrung4', 'vtrung5@gmail.com', '$2b$10$SSCMsjCplukDYokjBHH5GOZwFRU1X0ZCyJffCd2UepQuZ2oLvbt4i'),
